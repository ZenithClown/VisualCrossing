# Contributing to VisualCrossing

Do checkout the [contributing guide](../CONTRIBUTING.md) to see all the ways you can participate in this awesome project :sparkling_heart:! Here, you'll find additional information that might be helpful as you work on a pull request in this repository. **TODO**
