# Welcome to VisualCrosing Python API
...
Navigate our codebase with confidence :confetti_ball:! Check to see what [types of contributions](/contributing/types-of-contributions.md) we accept before making changes. Some of them don't even require writing a single line of code :sparkles:.

**Copied from GitHub docs - to fix and update and change**
